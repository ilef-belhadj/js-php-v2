...
document.addEventListener("DOMContentLoaded", function () {
    ...
    const continueButton = registrationForm.querySelector("button[type='button']");
    ...
    window.validateEmailOnInput = function(input) {
    ...
    window.validateEmailOnBlur = function(input) {
        const email = input.value;
    ...
    healthForm.style.opacity = "0.5";
    healthForm.style.pointerEvents = "none";
  
    // Form validation and continue button handling
    if (continueButton) {
        continueButton.addEventListener("click", function (e) {
            ...
            // Enable health form
            healthForm.style.opacity = "1";
            healthForm.style.pointerEvents = "auto";
