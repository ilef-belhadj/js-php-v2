...
CREATE TABLE IF NOT EXISTS parents (
    ...
    CONSTRAINT valid_password CHECK (
        ...
        password REGEXP '[A-Z]' AND  -- Au moins une majuscule
        password REGEXP '[a-z]' AND  -- Au moins une minuscule
        password REGEXP '[0-9]' AND  -- Au moins un chiffre
        password REGEXP '[!@#$%^&*(),.?":{}|<>]'  -- Au moins un caractère spécial
    )
